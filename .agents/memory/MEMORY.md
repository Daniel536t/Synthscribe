...
- [SynthScribe melody faithfulness](synthscribe-melody-faithfulness.md) — NOW: hum=seed only (key/tempo), user writes own lyrics ("Option B", AI drafting blocked by phone verify), ElevenLabs sings them; no hum-in-final, no resynth lead.
